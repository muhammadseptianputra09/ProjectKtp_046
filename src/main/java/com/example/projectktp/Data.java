...
@NamedQueries({
    ...
    @NamedQuery(name = "Data.findByKewarganegara", query = "SELECT d FROM Data d WHERE d.kewarganegara = :kewarganegara"),
...
public class Data implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "kewarganegara")
    private String kewarganegara;
    ...
    public Data(Long id, String nama, Date tgllahir, String jeniskelamin, String alamat, String agama, String status, String kewarganegara) {
        this.id = id;
        this.nama = nama;
        ...
        this.agama = agama;
        this.status = status;
        this.kewarganegara = kewarganegara;
    }
    ...
    public String getKewarganegara() {
        return kewarganegara;
    }

    public void setKewarganegara(String kewarganegara) {
        this.kewarganegara = kewarganegara;
    }
    ...
    public String toString() {
        return "com.example.projectktp.Data[ id=" + id + " ]";
    }
