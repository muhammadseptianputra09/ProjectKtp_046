...
import com.example.projectktp.exceptions.NonexistentEntityException;
import com.example.projectktp.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.example_projectktp_jar_0.0.1-SNAPSHOTPU") ;
